      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-[10px] text-muted-foreground mt-1">
              RSI-30: {obosOpenCount}/1 | Oil: {oilOpenCount}/1
            </p>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <Card>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-sm font-medium">RSI-30 Multi-Asset</CardTitle>
                <p className="text-[10px] text-muted-foreground mt-0.5">
                  20 assets | LONG only | 15m AND 1h RSI under 30 | 80% AUM | Max 1 | SL -2% | TP +2% | Flat (no BE)
                </p>
              </div>
          ...
          {openTrades.length > 0 ? (
            <div className="space-y-2">
              {openTrades.map((trade: any) => {
                ...
                const stratLabel = isOilNews ? "OIL" : (isBreakout ? "B&R" : "RSI-30");
                    ...
                    return (
                      <tr key={trade.id} className="border-b border-border/30 hover:bg-muted/30">
                        ...
                        <td className="py-1.5 px-1">
                          ...
                          >
                            {isOilTrade ? "OIL" : isBreakout ? "B&R" : "RSI-30"}
                          </Badge>
                        </td>
