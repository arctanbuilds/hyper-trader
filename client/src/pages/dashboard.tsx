      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="flex items-center gap-3 mt-0.5">
            <p className="text-sm text-muted-foreground">v15.6 — RSI-26 + SMC Core-4 + Oil News (both with BE+ profit lock)</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <Card>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-sm font-medium">RSI-26 + SMC Core-4</CardTitle>
                <p className="text-[10px] text-muted-foreground mt-0.5">
                  Core-4 | LONG | 5m+15m RSI≤26 + S/R ≤0.3% | 3 slots | SL -0.45% | TP +0.50% | BE+ @ +0.30%→+0.15%
                </p>
              </div>
          ...
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-[10px] text-muted-foreground mt-0.5">
                  WTI | L+S | Sonar 15m | $100 | SL -2% | TP +5% | BE+ @ +1.5%→+1.0%
                </p>
              </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        <Card>
          <CardHeader className="pb-2">
            ...
            <p className="text-[10px] text-muted-foreground">Starting from ${parseFloat(status?.startingEquity || "329").toFixed(2)} USDC baseline (v15.6) | {raceDays} running</p>
          </CardHeader>
          <CardContent>
